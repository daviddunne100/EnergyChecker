...
namespace EnergyChecker.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,LastName,FirstName,Email,PhoneNumber,RegistrationDate")] User user)
        {
            try
            {
        ...
        public ActionResult EditPost(int? id)
        {
            ...
            var userToUpdate = db.User.Find(id);
            if (TryUpdateModel(userToUpdate, "",
               new string[] { "ID","LastName","FirstName","Email","PhoneNumber","RegistrationDate" }))
            {
                try
                {
                    db.SaveChanges();
